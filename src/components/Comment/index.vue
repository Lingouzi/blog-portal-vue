...
<template>
    <div class="container">
        <div v-for="item in comments" :key="item.id" class="comment">
            <div class="info">
                <img class="avatar" :src="item.fromAvatar" width="36" height="36" alt="头像"/>
                <div class="right">
            ...
            <div class="reply">
                <div v-for="reply in item.reply" :key="reply.id" class="item">
                    ...
                    <div class="reply-bottom">
                        ...
                        <span class="reply-text" @click="showCommentInput(item, reply)"><i class="iconfont icon-comment"/><span>回复</span></span>
                    </div>
                </div>
...
<script>
    export default {
        ...
        computed: {},
        created() {
            console.log('created', this.comments)
        },
        methods: {
            /**
             * 点赞
